...
// isValidGitRepo verifies the repository at path is functional and is *the*
// repository at path — not just that a .git directory exists, and not a
// parent repository git discovered by walking up. Catches partial/corrupt
// clones from interrupted operations.
